...
<p class="well lead">&emsp;Unblock content</p>
...
<div id="page-content-wrapper">
              ...
              <div class="container">
                <div class="row"> <!-- div da esquerda -->
                    ...
                    <div class="col-sm-8 contact-form"> <!-- div da direita -->
                        <form id="contact" method="post" class="form" role="form" action="unblock_content.php">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-12 form-group">
                                    <button class="btn btn-primary pull-right" type="submit" name="unblock_content" value="Unblocked">Unblock</button>
        ...
        <div class="container" style="padding-top: 20px;">
          <div class="row">         
            <div class="alert alert-success fade in">
              ...
              <p>Post successfully unblocked.</p>
            </div>
         </div>
        </div>
    ...
    elseif($_SESSION['block_status'] == 11)
    {
        ?>
    ...
    elseif($_SESSION['block_status'] == 12)
    {
        ?>
