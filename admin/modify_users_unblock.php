...
<!-- Page content -->
              ...
              <div class="container">
                <div class="row"> <!-- div da esquerda -->
                    ...
                    <div class="col-sm-8 contact-form"> <!-- div da direita -->
                        <form id="contact" method="post" class="form" role="form" action="unblock_users.php">
                            
                            <br>
                            <div class="row">
                                <div class="col-xs-6 col-md-9 form-group">
                                    <input class="form-control" id="inputcidade" name="username" placeholder="Enter username to be unblocked" type="text" />
                                </div>
        ...
        <div class="container" style="padding-top: 20px;">
          <div class="row">         
            <div class="alert alert-success fade in">
              ...
              <p>User successfully unblocked.</p>
            </div>
         </div>
        </div>
    ...
    elseif($_SESSION['block_status'] == 5)
    {
        ?>
